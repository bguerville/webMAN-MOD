...
typedef struct
{
	int (*DoUnk0)();                          // 0 Parameter: (creates page_game_main widget)
	...
	int (*DoUnk8)();                          // 0 Parameter: returns uint8
	...
	int (*DoUnk15)();                         // 0 Parameter: disables 2 second sleep on ps2bootparam.dat
	...
	int (*DoUnk18)();                         // 0 Parameter: returns uint8
	...
	int (*DoUnk30)();                         // 0 Parameter: set autodownload skip
	int (*DoUnk31)();                         // 0 Parameter: returns uint8
